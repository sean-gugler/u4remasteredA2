...
j_overlay_entry:
	jsr j_primm  ;b'WHICH ITEM:\r\x00'
	.byte "WHICH ITEM:", $8d
	.byte 0
	jsr get_input
	jsr compare_keywords
	bpl keyword_matched
	jsr j_primm  ;b'\rNOT USABLE ITEM!\r\x00'
	.byte $8d
...
print_none_owned:
	jsr j_primm  ;b'\rNONE OWNED!\r\x00'
	.byte $8d
	.byte "NONE OWNED!", $8d
	.byte 0
	rts
...
print_no_effect:
	jsr j_primm  ;b'\rHMM...NO EFFECT!\r\x00'
	.byte $8d
...
keyword_handlers:
	.word use_stone,use_bell,use_book,use_candle,use_key
	.word use_horn,use_wheel,use_skull
...
@have_stone:
	jsr j_primm  ;b'\rNO PLACE TO\rUSE THEM!\r\x00'
	.byte $8d
	.byte "NO PLACE TO", $8d
	.byte "USE THEM!", $8d
	.byte 0
...
@have_skull:
	jsr j_primm  ;b'\rYOU HOLD THE\rEVIL SKULL OF\rMONDAIN THE\rWIZARD ALOFT....\r\x00'
	.byte $8d
...
keywords:
	.byte $d3,$d4,$cf,$ce,$c2,$c5,$cc,$cc
	.byte $c2,$cf,$cf,$cb,$c3,$c1,$ce,$c4
	.byte $cb,$c5,$d9,$a0,$c8,$cf,$d2,$ce
	.byte $d7,$c8,$c5,$c5,$d3,$cb,$d5,$cc
